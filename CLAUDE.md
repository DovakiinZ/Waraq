...
- **ACTION REQUIRED — run `supabase/migrations/104_rls_and_missing_rpcs.sql`.** Findings from auditing all 39 tables and 12 functions the clients touch, probed against the live database on 2026-09-22:
...
Published so far: `v1.0.0-android`, `v1.0.1-android`, `v1.0.2-android`.
